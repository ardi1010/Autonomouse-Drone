...
async def data_database():
    global altitude, waktu_altitude, groundspeed, waktu_groundspeed, latitude, waktu_latitude, longitude, waktu_longitude, windspeed, waktu_windspeed, battery, waktu_Battery, waktu, nextwaypoint
    ...
    nextwaypoint = vehicle.commands.next
    return altitude, waktu_altitude, groundspeed, waktu_groundspeed, latitude, waktu_latitude, longitude, waktu_longitude, windspeed, waktu_windspeed, battery, waktu_Battery, waktu

async def dic_database():
    global push_altitude, push_groundspeed, push_latitude, push_longitude, push_windspeed, push_battery
    ...
    return push_altitude, push_groundspeed, push_latitude, push_longitude, push_windspeed, push_battery
...
async def smartSprayer():
    ...
    if nextwaypoint == 2 or nextwaypoint == 4:
...
while True:
   ...
   # print("nxt while true: ", nextwaypoint)
    if nextwaypoint == 1 or nextwaypoint == 2 or nextwaypoint == 3:
        # print("masuk if else")
